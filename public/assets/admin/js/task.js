    ...
    $(document).ready(function () {
        ...
        var addTask = function () {
            ...
            if (newTask === '') {
                ...
                // Show notification
                updateNotification(newTask, 'Agregado a la lista');
        ...
        $('#task-list').on('click', '.task-action-btn .delete-btn', function () {
            ...
            task.remove();
            updateNotification(taskText, ' ha sido eliminado.');
        });
        ...
        $('#task-list').on('click', '.task-action-btn .complete-btn', function () {
            ...
            task.hasClass('completed') ? updateNotification(taskText, 'tarea incompleta.') : updateNotification(taskText, ' Tarea completada.', 'success');
