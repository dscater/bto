<!-- Add actividad Modal -->
<div id="add_actividad" class="modal custom-modal fade" role="dialog">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form data-toggle="validator" role="form" action="{{ route('actividads.store') }}" method="post" enctype="multipart/form-data">
                    {{ csrf_field() }}
