<!-- Delete actividad Modal -->
<div class="modal custom-modal fade" id="delete_empresa{{ $actividad->id }}" role="dialog">
        ...
        <div class="modal-content">
            <div class="modal-body">
                ...
                <div class="modal-btn delete-action">
                    <div class="row">
                        <div class="col-6">
                            <form method="POST" action="{{ route('empresas.destroy', $actividad->id) }}">
                                {!! method_field('DELETE') !!}
                                {{ csrf_field() }}
