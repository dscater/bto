                ...
                <div class="card-body">
                    <div id="contenedorFecha">
                        ...
                        @if (Auth::user()->tipo == 'EMPLEADO')
                            <button type="button" id="btnMarcaHora" class="btn btn-primary"><i
                                    class="fa fa-clock"></i><span></span></button>
                        @endif
                    </div>
                </div>
            </div>
...
@section('js')
    ...
    {{-- GRAFICAS --}}
    @if (Auth::user()->tipo == 'AUXILIAR')
        <script src="{{ asset('js/graficos/cantidad_empleados.js') }}"></script>
        <script src="{{ asset('js/graficos/tiempo_productividad.js') }}"></script>
        <script src="{{ asset('js/graficos/ingresos_economicos.js') }}"></script>
        <script src="{{ asset('js/graficos/capacitacion.js') }}"></script>
        <script src="{{ asset('js/graficos/asistencia_empleados.js') }}"></script>
        <script src="{{ asset('js/graficos/progreso_proyectos.js') }}"></script>
        <script src="{{ asset('js/graficos/ganancia_empleados.js') }}"></script>
        <script src="{{ asset('js/graficos/progreso_actividad_empleados.js') }}"></script>
    @endif
    @if (Auth::user()->tipo == 'ADMINISTRADOR')
        <script src="{{ asset('js/graficos/ingresos_economicos.js') }}"></script>
        <script src="{{ asset('js/graficos/progreso_proyectos.js') }}"></script>
