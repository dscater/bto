<!-- Add horario Modal -->
<div id="add_horario" class="modal custom-modal fade" role="dialog">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form data-toggle="validator" role="form" action="{{ route('horarios.store') }}" method="post" enctype="multipart/form-data">
                    {{ csrf_field() }}

                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label>Nombre Horario <span class="text-danger">*</span></label>
